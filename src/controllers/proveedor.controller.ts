...
export const getProveedoresFiltrada = async (req: Request, res: Response) => {

    const negocio_id = 1
    try {
        
        const proveedores = await ProveedorSevice.listaProveedoresFiltrada(negocio_id);
...
export const getProveedores = async (req: Request, res: Response) => {
    ...
    try {
        ...
        const proveedores = await ProveedorSevice.listaProveedores();
